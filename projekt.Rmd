...
V projektu bom analizirala ne zdravi način življenja ljudi po posameznih državah v Evropi. Zanimalo me bo tudi ali ima na nezdravi življenski slog kakšen vpiv izobrazba in spol. Osredotočila se bom na naslednje determinante zdravja: povišano telesno težo, pitje alkohola, kajenje, telesno aktivnost in dnevno zauživanje sadja ali zelenjave.
...
V prvi tabeli so predstavljeni podatki glede na države v drugi tabeli pa glede na izobrazbo in spol. Obe tabeli imata naslednje stolpce enkein sicer:
